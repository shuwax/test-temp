...
export declare class OrganizationsAPI {
    ...
    createOrganization: (body: OrganizationCreateModel) => Promise<DataModel<"OrganizationViewModel">>;
    getOrganizationById: (id: number) => Promise<DataModel<"OrganizationViewModel">>;
    ...
    removeMultipleUsersFromSubOrganization: (id: number, usersIds: number[]) => Promise<any>;
