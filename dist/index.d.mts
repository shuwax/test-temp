...
type PathModel<T, U> = paths[T & keyof paths][U &
  keyof paths[T & keyof paths]];
type BodyModel<T, U> = paths[T & keyof paths][U &
  keyof paths[T & keyof paths]];

// Generic utility type to extract a specific parameter type from an endpoint
type ParametersOfType<
...
export type { BodyModel, DataModel, ParametersOfType, PathModel, PathParameters, QueryParameters };
